...
<head>
  ...
  <title>Komisyon Giriş Ekranı</title>
  <!-- Favicon -->
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              ...
              <h3 style="color: #343A40;" class="new-font">Komisyon Giriş Ekranı <i class="fas fa-info-circle"></i></h3>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="card-body px-lg-5 py-lg-5">
                  <?php if(isset($_SESSION['c_message'])): ?>
                      <div class="alert" style="color: red; text-align:center;">
                          <?php echo '<p class="new-font"><i class="fas fa-exclamation-circle"></i> '.$_SESSION['c_message'].'</p>';
                              unset($_SESSION['c_message']);
                          ?>
                      </div>
                  <?php endif ?>
              <form method="POST" action="process/commission_login.php">
                <div class="form-group mb-3">
                  <div class="input-group input-group-alternative">
                    <div class="input-group-prepend">
                      <span class="input-group-text"><i class="ni ni-hat-3"></i></span>
                    </div>
                    <input name="commission_number" class="form-control" placeholder="Komisyon Numarası" type="text" required>
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group input-group-alternative">
                    ...
                    <input name="commission_password" class="form-control" placeholder="Parola" type="password" required>
                  </div>
                </div>
                <div class="text-center">
                  <button type="submit" name="commission-login-btn" class="btn btn-success my-4"><i class="fas fa-sign-in-alt"></i> Komisyon Girişi</button>
                </div>
                <a href="teacher_login.php?teacher-login" style="font-size:15px ;">Sign in as Teacher?</a><br>
                <a href="admin_login.php?admin-login" style="font-size:15px ;">Sign in as Admin?</a><br>
                <a href="index.php?student-login" style="font-size:15px ;">Sign in as Student?</a><br>
              </form>
            </div>
          </div>
        </div>
