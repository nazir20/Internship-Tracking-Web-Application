        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              ...
              <h3 style="color: #343A40;" class="new-font">Öğretmen Giriş Ekranı <i class="fas fa-info-circle"></i></h3>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="card-body px-lg-5 py-lg-5">
                ...
                <div class="form-group mb-3">
                  <div class="input-group input-group-alternative">
                    ...
                    <input name="teacher-number" class="form-control" placeholder="Öğretmen Numarası" type="text" required>
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group input-group-alternative">
                    ...
                    <input name="teacher-password" class="form-control" placeholder="Parola" type="password" required>
                  </div>
                </div>
                <div class="text-center">
                  <button type="submit" name="teacher-login-btn" class="btn btn-success my-4"><i class="fas fa-sign-in-alt"></i> Öğretmen Girişi</button>
                </div>
                <a class="new-font" href="admin_login.php?admin-login" style="font-size:15px ;">Sign in Admin?</a><br>
