...
<head>
  ...
  <title>Staj Takibi -Anasayfa</title>
  <!-- Favicon -->
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              ...
              <h3 style="color: #343A40;" class="new-font">KOÜ Staj & İME Takip Sistemi</h3>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form method="POST" action="process/student_login.php">
                ...
                <div class="text-center">
                  <button name="student_login_btn" type="submit" class="btn btn-success my-4"><i class="fas fa-sign-in-alt"></i> Öğrenci Girişi</button>
                </div>
